...
public class Pg02_Ej9 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Esto es de lo que te hablo, declaras un int, usas el método de la clase Integer
		 * para pasar un String a int y a ese método (el método parseInt) se le pasa por
		 * parámetro un String, entonces, toda la sentencia del JOptionPane al final
		 * representa el String que introduzcas tú en la ventanica que sale.
		 */
